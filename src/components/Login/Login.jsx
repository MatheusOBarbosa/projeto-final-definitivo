  ...
  return (
    <div>
      <section id="btn-call-registro">
        {usuarioLogado ? (
          <div>
            <a href="#user-page" onClick={toggleProfile}>
              {usuarioLogado}
            </a>
          </div>
        ) : (
      ...
      <section id="login-page" className={`${hidden ? "hidden" : ""}`}>
          ...
          <div className="controle-registro">
            <button
              ...
              onClick={(e) => {
                ...
                toggleHidden();
                alert(
                  "Parabens! Sua conta foi registrada com sucesso, agora recarregue a pagina e entre em sua conta em SIGN UP"
                );
              }}
            >
              Continue
        ...
        <div
          id="cadastro-login"
          className={`${showCadastroLogin ? "" : "hidden"}`}
        >
          ...
          ? usuarios.map((item) => {
              return (
                <div key={item.id}>
                  <div>
                    {" "}
                    <b>Usuario:</b> {item.nome} - <b>Email:</b> {item.email} - <b>Senha:</b> {item.senha}{" "}
                    {usuarioLogado === item.nome && (
